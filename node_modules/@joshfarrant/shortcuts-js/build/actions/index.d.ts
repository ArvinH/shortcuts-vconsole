...
export { addToReadingList, addToVariable, airDrop, ask, base64Encode, calculate, calculateStatistics, call, changeCase, chooseFromMenu, clearUpNext, comment, conditional, continueShortcutInApp, correctSpelling, count, createAlarm, createNote, date, deletePhotos, detectLanguageWithMicrosoft, dictionary, exitShortcut, expandURL, extractArchive, facetime, formatDate, generateHash, getAddressesFromInput, getBatteryLevel, getClipboard, getContactsFromInput, getContentsOfURL, getContentsOfWebPage, getCurrentIPAddress, getCurrentLocation, getCurrentSong, getDatesFromInput, getDeviceDetails, getDictionaryFromInput, getDictionaryValue, getDiffbotArticleFromWebPage, getEmailAddressesFromInput, getFramesFromImage, getHeadersOfURL, getImagesFromInput, getLastImport, getLatestBursts, getLatestLivePhotos, getLatestScreenshots, getLatestVideos, getLinkToFile, getMapsURL, getMyShortcuts, getName, getNameOfEmoji, getNetworkDetails, getPhoneNumbersFromInput, getTextFromInput, getTimeBetweenDates, getType, getURLsFromInput, getVariable, list, makeArchive, makeMarkdownFromRichText, makeRichTextFromHTML, makeRichTextFromMarkdown, markup, matchText, nothing, number, openApp, openInBooks, openURLs, openURLsInChrome, pauseMusic, postOnFacebook, postOnInstagram, playSound, postToTumblr, postToWordPress, print, quickLook, randomNumber, removeReminders, repeat, runHomeScene, runJavaScriptOnWebPage, runScriptOverSSH, runShortcut, scanQROrBarcode, selectEmailAddress, selectPhoneNumber, setAirplaneMode, setBluetooth, setBrightness, setCellularData, setDictionaryValue, setDoNotDisturb, setLowPowerMode, setName, showInMaps, setTorch, setVariable, setVolume, setWiFi, share, shareWithExtensions, showAlert, showDefinition, showInCalendar, showInITunesStore, showNotification, showResult, skipBack, skipForward, speakText, text, tweet, trimMedia, URL, URLEncode, vibrateDevice, viewContentGraph, wait, waitToReturn, pythonista, };
